        ...
        {category.modules.map((mod) => (
          <motion.div key={mod.slug} variants={fadeUp}>
            <Link href={`/${category.slug}/${mod.slug}`}
              className="group glass-card rounded-2xl p-5 block min-h-[130px] flex flex-col justify-between">
              <div>
              ...
              <div className="flex items-center justify-between mt-3">
                <Badge variant="secondary" className="text-[10px] font-normal capitalize">{mod.archetype}</Badge>
